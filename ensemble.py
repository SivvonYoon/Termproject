...
model0 = "resnet18_cifar10_0.0001_65e_96.04_adam.pth"
model1 = "resnet18_cifar10_0.0001_70e_96.22_adam.pth"
model2 = "resnet18_cifar10_0.0001_138e_96.3_adam.pth"
# model2 = "resnet18_cifar10_0.01lr_193epoch_95.23acc.pth"
# model2 = "resnet18_cifar10_0.01lr_113epoch_94.85acc.pth"
...
for i in range(model_num):
    ...
    model.load_state_dict(torch.load(model_list[i]))  # Load the trained weights
...
PATH = './resnet18_cifar10_ensemble_%f_acc.pth' % acc
torch.save(model.state_dict(), PATH)
print('Accuracy of the ensemble on the 10000 test images: %f %%' % (acc))
